    ...
    companion object {
        ...
        fun representativeExamples(): Stream<RepresentativeExample> =
            Stream.of(
                ...
                RepresentativeExample.gap("optionalVsRequired", "untyped object representation"),
                RepresentativeExample.gap("validationAnnotations", "nested validation annotation selection"),
                RepresentativeExample.gap("arrays", "top-level and nested array model generation"),
                RepresentativeExample.gap("mapExamples", "additional-properties accessors"),
