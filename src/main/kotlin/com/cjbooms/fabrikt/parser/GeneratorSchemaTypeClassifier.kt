...
internal object GeneratorSchemaTypeClassifier {
    ...
    private fun intersect(
        ...
        if (referenced is GeneratorSchemaTypeClassification.Uninhabitable) return referenced
        if (sibling is GeneratorSchemaTypeClassification.Uninhabitable) return sibling
